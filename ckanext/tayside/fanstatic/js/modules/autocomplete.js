 ...
 *
 * This module is basically the same as the core autocomplete module, except
 * that it sends an additional "owner_org" query params, that excludes users
 * that are already part of that organization.
 *
 ...
 *
 */
this.ckan.module('tayside-autocomplete', function (jQuery) {
  return {
    ...
    getCompletions: function (string, fn) {
      var owner_org = $('select[name="owner_org"]').val();
      var parts  = this.options.source.split('?');
      var end    = parts.pop();
      var source = parts.join('?') + encodeURIComponent(string) + end + '&owner_org=' + owner_org;
