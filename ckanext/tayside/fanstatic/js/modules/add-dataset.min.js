this.ckan.module('add-dataset-modal',function($){'use strict';return{initialize:function(){$.proxyAll(this,/_on/)
...
this.dismissButton.on('click',this._onCloseModal)},_onAddDatasetClick:function(event){this.datasetModal.show()
this.datasetModalBackdrop.show()},_onCloseModal(event){this.datasetModal.hide()
