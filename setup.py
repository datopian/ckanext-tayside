...
setup(
    ...
    description='''"Main theme extension for Tayside project"''',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/duskobogdanovski/ckanext-tayside',
